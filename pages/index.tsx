    ...
    <>
      ...
      <div className={home.row}>
        ...
        <div className={home.inner}>
          <h1 className="text-4xl inline-block mb-4">配信用&nbsp;時計オーバーレイ</h1>
          <div className="text-base font-mono">
            ...
            <ol className="list-inside list-decimal">
              ...
              <li>カスタムCSSに記載がない場合は以下をコピー&amp;ペースト<div>body&#123;background-color: rgba(0, 0, 0, 0);&#125;</div></li>
            </ol>
          </div>
          
        </div>
          <small className="px-5 box-border">
            <p>
